...
if ($search_query) {
    $search_results = search_reelshort($search_query);
} else {
        ...
        <div class="container-fluid px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center">
                    <form class="d-flex me-3" action="reelshort.php" method="GET">
                        <input type="text" name="search" class="form-control form-control-sm bg-dark border-secondary text-white rounded-pill px-3" placeholder="Search ReelShort..." value="<?php echo htmlspecialchars($search_query); ?>">
            ...
            <div class="section-container mb-5">
                ...
                <div class="container-fluid px-lg-5">
                    ...
                    <?php elseif (empty($search_results)): ?>
                        <div class="alert alert-custom p-4" style="background-color: rgba(255, 0, 85, 0.1); border: 1px solid var(--primary-color); color: #fff;">No results found for "<?php echo htmlspecialchars($search_query); ?>"</div>
                    <?php else: ?>
        ...
        <div class="container mt-5">
            <div class="alert alert-danger p-4 shadow-sm border-0 rounded-4">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 fw-bold">Scraping issue</h5>
